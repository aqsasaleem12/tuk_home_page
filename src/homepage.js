  ...
  return (
    <>
      <div className=" bg-[#030014]">
        ...
        <div className="fixed w-full bg-main top-0 colo-gradient py-5 ">
          <div className="flex items-center relative  justify-between max-w-7xl w-full mx-auto">
            ...
            <div className="bgr-light absolute w-[400px] h-[300px] left-[40%] right-[50%]"></div>
          </div>
        </div>
        ...
        <div className="main-sec">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex justify-center mt-11 gap-8">
              <img
        ...
        <div className="mt-11 w-full">
          <div className="border border-white/10 mx-auto !rounded-xl max-w-[1029px]  p-2">
            <img
